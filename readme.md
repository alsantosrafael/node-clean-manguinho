...
Esse readme utiliza conteúdo proveniente do curso do professor Rodrigo Manguinho. Ele foi construído tomando como base o readme existente em seu repositório que pode ser encontrado em: [**Link para a o github do manguinho**](http://github.com/rmanguinho/clean-ts-api/blob/master/readme.md). Declaro que não sou dono do conteúdo descrito aqui nesse readme, apenas o adaptei em meu repositório, construído ao longo do treinamento, de forma a torná-lo mais atrativo.
